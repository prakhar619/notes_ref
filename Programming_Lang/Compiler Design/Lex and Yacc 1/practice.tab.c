...
#line 1132 "practice.tab.c"
    break;

  case 7: /* varList: ID  */
#line 42 "practice.y"
                                                                {strcpy(currID[idCount],(yyvsp[0].str)); idCount++;}
#line 1138 "practice.tab.c"
    break;

  case 9: /* stmtList: stmt  */
#line 43 "practice.y"
                                                                {}
#line 1144 "practice.tab.c"
    break;
...
#line 1162 "practice.tab.c"
    break;

  case 13: /* exp: exp '-' term  */
#line 47 "practice.y"
                                                                {(yyval.val) = (yyvsp[-2].val) - (yyvsp[0].val);}
#line 1168 "practice.tab.c"
    break;
...
#line 49 "practice.y"
                                                                {(yyval.val) = (yyvsp[-2].val) * (yyvsp[0].val);}
#line 1180 "practice.tab.c"
    break;

  case 16: /* term: term '/' factor  */
#line 50 "practice.y"
                                                                {(yyval.val) = (yyvsp[-2].val) / (yyvsp[0].val);}
#line 1186 "practice.tab.c"
    break;

  case 17: /* term: factor  */
#line 51 "practice.y"
                                                                {}
#line 1192 "practice.tab.c"
    break;

  case 18: /* factor: ID  */
#line 52 "practice.y"
                                                                {}
#line 1198 "practice.tab.c"
    break;


#line 1202 "practice.tab.c"
